      ...
      html: `
        ...
        <html>
          ...
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            <p style="margin: 0 0 16px 4px; font-size: 16px; color: #374151;">
                Hey <strong>${username}</strong>,
            </p>
            <div style="background: linear-gradient(135deg, #2563EB 0%, #60A5FA 100%); padding: 30px; border-radius: 10px 10px 0 0; text-align: center;">
              ...
              <table style="width: 100%; margin: 20px 0;">
                ...
                <tr>
                  <td style="padding: 10px;">
                    ...
                    <div style="font-size: 32px; color: #2563EB; font-weight: bold;">
...
{/* <div style="border-top: 1px solid #e5e7eb; padding-top: 20px; margin-top: 20px; text-align: center; color: #6b7280; font-size: 12px;">
                ...
                <p style="margin-top: 10px;">
                  <a href="${process.env.NEXT_PUBLIC_APP_URL}" style="color: #2563EB; text-decoration: none;">
